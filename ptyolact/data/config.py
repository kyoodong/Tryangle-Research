from ptyolact.backbone import ResNetBackbone, VGGBackbone, ResNetBackboneGN, DarkNetBackbone
...
COCO_CLASSES = ('person', 'bottle', 'wine glass', 'cup')

COCO_LABEL_MAP = {1:  1, 44: 2, 46: 3, 47: 4}
