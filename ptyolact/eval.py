from ptyolact.data import COCODetection, get_label_map, MEANS, COLORS
from ptyolact.yolact import Yolact
from ptyolact.utils.augmentations import BaseTransform, FastBaseTransform, Resize
from ptyolact.utils.functions import MovingAverage, ProgressBar
from ptyolact.layers.box_utils import jaccard, center_size, mask_iou
...
from ptyolact.data import cfg, set_cfg, set_dataset
...
def parse_args(argv=None):
    ...
    parser.add_argument('--soft_nms', default=True, type=str2bool,
                        help='Whether to use a soft_nms')
...
def evaluate(net:Yolact, dataset, train_mode=False):
    ...
    net.detect.use_soft_nms = args.soft_nms
    net.detect.use_cross_class_nms = args.cross_class_nms
    cfg.mask_proto_debug = args.mask_proto_debug

    print(f"use_fast_nms: {net.detect.use_fast_nms}, soft_nms: {net.detect.use_soft_nms}")
...
if __name__ == '__main__':
    ...
    if args.config is not None:
        print(f"Setting config {args.config}")
        set_cfg(args.config)
